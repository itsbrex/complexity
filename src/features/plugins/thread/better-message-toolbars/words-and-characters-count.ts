...
const displayWordsAndCharactersCount = async ({
  ...
  const queryWordsAndCharactersCountContainer = createQueryHoverContainer(
    `${t("common:misc.words")}: ${queryWordsCount}, ${t("common:misc.characters")}: ${queryCharactersCount}${shouldDisplayTokensCount ? `, ${t("common:misc.tokens")}: ~${queryTokensCount}` : ""}`,
  );
  ...
  const answerWordsAndCharactersCountContainer = createAnswerHeadingContainer(
    `${t("common:misc.words")}: ${answerWordsCount}, ${t("common:misc.characters")}: ${answerCharactersCount}${shouldDisplayTokensCount ? `, ${t("common:misc.tokens")}: ~${answerTokensCount}` : ""}`,
  );
